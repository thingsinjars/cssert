...
*/
  ...
  linkStylesheetToString = function() {
    ...
    jQs.onload = function() {
      testDisplay = $('<pre id="cssert-pre" class="cssert-modal"></pre>');
      dragHandle = $('<div id="cssert-drag" class="cssert-modal"><img src="https://github.com/thingsinjars/cssert/raw/master/introduction/package.png" id="cssert-download" class="cssert-modal"></div>');
      ...
      var styleForm = $('<form>').attr('id', 'cssert-style-modal').addClass('cssert-modal'), setHeader, styleList;
      if(styles) {
        styleList = $('<ul>');
    ...
    var cssertStyles = ".cssert-modal {display:none;z-index:1000;position:fixed;border-radius:5px;}";
    ...
    cssertStyles += "#cssert-style-modal>ul>li>label {text-align:left;color:white;font-size:15px !important;}";
    ...
    cssertStyles += "#cssert-pre {position:fixed !important;top:10px !important;right:10px !important;background:white !important;border:1px solid gray !important;width:200px !important;height:200px !important;overflow:auto !important;}";
    cssertStyles += "#cssert-drag {position:fixed !important;top:210px !important;right:10px !important;background:white !important;border:1px solid gray !important;width:200px !important;height:20px !important;overflow:auto !important;}";
})();

...
*/
  ...
  linkStylesheetToString = function() {
    ...
    wrapInPage = function(testCode) {
      return '<!doctype html><html><head><title>cssert test page</title><link rel="stylesheet" href="../lib/cssert.css"></head><body><h1>cssert Test cases</h1><p>click to expand test</p><script type="text/html">/*' + testCode + '*/</script><script src="../lib/cssert.js"></script></body></html>';
    };
